...
{
    public partial class implementNewEntityDomainn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityStock = table.Column<string>(type: "text", nullable: false),
                    PublishingCompanyId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityBookBought = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CostumerBuyBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CostumerBuyBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CostumerBuyBooks_Costumers_CostumerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CostumerBuyBooks_BookId",
                table: "CostumerBuyBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_CostumerBuyBooks_CostumerId",
                table: "CostumerBuyBooks",
                column: "CostumerId");
        }
